export const siteData = {
  ...
  hero: {
    ...
    collageFloat: "/images/hero-interior-modern.jpg",
  },
  about: {
    title: "À propos",
  ...
  servicesCards: [
    {
      id: "epilation-electrolyse",
      title: "L'ÉPILATION: ÉLECTROLYSE THERMOLYSE - BLEND",
      ...
      duration: "5 min - 1 h",
      price: "25 € - 126 €",
      image: "/images/electrolyse.jpg",
      benefits: ["Définitif", "Précis", "Toutes couleurs"],
    },
    {
      id: "electrocoagulation-angiomes",
      title: "ELECTROCOAGULATION (ANGIOMES)",
      desc: "Traitement des angiomes (malformations bénignes des vaisseaux sanguins). Petites taches rouges ou violettes sur la peau.",
      duration: "10–20 min",
      price: "à partir de 25 €",
      image: "/images/IMG_0111.jpg",
      benefits: ["Efficace", "Précis", "Rapide"],
    },
    {
      id: "laser-diode",
      title:
        "L'ÉPILATION AU LASER DIODE: Femmes - Hommes: prix/séance (6 séances + 2)",
      desc: "Épilation laser diode pour femmes et hommes. 6 séances + 2 offertes. Zones au choix.",
      duration: "20–40 min",
      price: "18 € - 720 €",
    ...
    },
    {
      id: "laser-ipl",
      title:
        "L'ÉPILATION À L'IPL: Femmes - Hommes: prix/séance (6 séances + 2 offertes)",
      desc: "Épilation IPL pour femmes et hommes. 6 séances + 2 offertes. Traitement lumière pulsée.",
      duration: "20–40 min",
      price: "18 € - 900 €",
    ...
    },
    {
      ...
      desc: "Soin anti-âge premium avec techniques avancées et produits haut de gamme.",
      duration: "1 h 30",
      price: "à partir de 103,50 €",
      image: "/images/IMG_0109.jpg",
      benefits: ["Anti-âge", "Premium", "Résultats"],
    },
    {
      id: "cire-lycon",
      title: "L'EPILATION À LA CIRE LYCON",
      desc: "Épilation à la cire Lycon de qualité professionnelle.",
      duration: "15–30 min",
      price: "10 € - 50 €",
      image: "/images/cire.jpg",
      benefits: ["Lycon", "Professionnel", "Rapide"],
    },
    {
      id: "cire-classique",
      title: "L'ÉPILATION À LA CIRE CLASSIQUE",
      desc: "Épilation à la cire classique traditionnelle.",
      duration: "15–30 min",
      price: "13 € - 50 €",
      image: "/images/IMG_0098.jpg",
      benefits: ["Classique", "Traditionnel", "Efficace"],
    },
    {
      id: "cire-forfait-femmes",
      title: "L'ÉPILATION À LA CIRE CLASSIQUE: FORFAIT FEMMES",
      desc: "Forfait épilation à la cire classique spécialement conçu pour les femmes.",
      duration: "30–45 min",
      price: "13 € - 50 €",
      image: "/images/IMG_0097.jpg",
      benefits: ["Forfait", "Femmes", "Complet"],
    },
    {
      id: "cire-forfait-hommes",
      title: "L'ÉPILATION À LA CIRE CLASSIQUE FORFAIT: HOMMES",
      desc: "Forfait épilation à la cire classique spécialement conçu pour les hommes.",
      duration: "30–45 min",
      price: "20 € - 50 €",
      image: "/images/IMG_0096.jpg",
      benefits: ["Forfait", "Hommes", "Complet"],
    },
    {
      id: "soins-visage",
      title: "LES SOINS DU VISAGE",
      desc: "Soins du visage personnalisés selon votre type de peau et vos besoins.",
      duration: "45 min - 1 h",
      price: "30 € - 103,50 €",
      image: "/images/gallery-1.jpg",
      benefits: ["Personnalisé", "Qualité", "Résultats"],
    },
    {
      id: "peelings-visage",
      title: "LES PEELINGS DU VISAGE",
      desc: "Peelings du visage pour renouveler la peau et améliorer la texture.",
      duration: "30–45 min",
      price: "30 € - 103,50 €",
      image: "/images/gallery-2.jpg",
      benefits: ["Renouvellement", "Texture", "Éclat"],
    },
    {
      id: "micro-needling",
      title: "LE MICRO NEEDLING DU VISAGE",
      desc: "Micro needling pour stimuler la production de collagène et améliorer la texture.",
      duration: "45 min",
      price: "30 € - 103,50 €",
      image: "/images/gallery-3.jpg",
      benefits: ["Collagène", "Texture", "Régénération"],
    },
    {
      id: "therapie-led",
      title: "LA THÉRAPIE LED DU VISAGE",
      desc: "Thérapie LED pour traiter les imperfections et améliorer l'éclat du visage.",
      duration: "20 min",
      price: "30 € - 103,50 €",
      image: "/images/gallery-4.jpg",
      benefits: ["LED", "Imperfections", "Éclat"],
    },
    {
      id: "massages",
      title: "LES MASSAGES",
      desc: "Massages relaxants et thérapeutiques pour le corps et l'esprit.",
      duration: "30 min - 1 h 30",
      price: "35 € - 117 €",
      image: "/images/IMG_0103.jpg",
      benefits: ["Relaxation", "Thérapeutique", "Bien-être"],
    },
  ],
  treatwellServices: [
    {
